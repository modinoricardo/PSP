...
public class EjerPadre {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		File dirGeneraNum = new File("/home/richi/Escritorio/practicaMultiprocesos/Ejer1GeneraNum/bin");
		...
		while (sc1.hasNextLine()) {
			...
			cadenaNumeros.append(num).append("\n");

		}
		sc1.close();
		System.out.println("Fin la salida del programa de generacion de impares");

		File dirOrdenarNum = new File("/home/richi/Escritorio/practicaMultiprocesos/Ejer1OrdenaNum/bin");
		...
		oS.write(cadenaNumeros.toString().getBytes());
		oS.flush();
